function ssc_init() {
    if (document.body) {
        ...
        if (ssc_root = document.compatMode.indexOf("CSS") >= 0 ? t : e, ssc_activeElement = e, 
        ssc_initdone = !0, top != self) ssc_frame = !0; else if (r > n && (e.offsetHeight <= n || t.offsetHeight <= n) && (ssc_root.style.height = "auto", 
        ssc_root.offsetHeight <= n)) {
            var i = document.createElement("div");
            i.style.clear = "both", e.appendChild(i);
        }
        ssc_fixedback || (e.style.backgroundAttachment = "scroll", t.style.backgroundAttachment = "scroll"), 
        ssc_keyboardsupport && ssc_addEvent("keydown", ssc_keydown);
    }
}

function ssc_scrollArray(e, t, n, r) {
    if (r || (r = 1e3), ssc_directionCheck(t, n), ssc_que.push({
        x: t,
        y: n,
        lastX: 0 > t ? .99 : -.99,
        lastY: 0 > n ? .99 : -.99,
        ...
        var i = function() {
            for (var s = +new Date(), o = 0, u = 0, a = 0; a < ssc_que.length; a++) {
                var f = ssc_que[a], l = s - f.start, c = l >= ssc_animtime, h = c ? 1 : l / ssc_animtime;
                ssc_pulseAlgorithm && (h = ssc_pulse(h));
                var p = f.x * h - f.lastX >> 0, d = f.y * h - f.lastY >> 0;
                o += p, u += d, f.lastX += p, f.lastY += d, c && (ssc_que.splice(a, 1), a--);
            }
            if (t) {
                var v = e.scrollLeft;
            ...
            if (n) {
                var m = e.scrollTop;
                e.scrollTop += u, u && e.scrollTop === m && (n = 0);
            }
            t || n || (ssc_que = []), ssc_que.length ? setTimeout(i, r / ssc_framerate + 1) : ssc_pending = !1;
        };
...
function ssc_wheel(e) {
    ...
    var t = e.target, n = ssc_overflowingAncestor(t);
    ...
    r || i || (i = e.wheelDelta || 0), Math.abs(r) > 1.2 && (r *= ssc_stepsize / 120), 
    Math.abs(i) > 1.2 && (i *= ssc_stepsize / 120), ssc_scrollArray(n, -r, -i), e.preventDefault();
}

function ssc_keydown(e) {
    var t = e.target, n = e.ctrlKey || e.altKey || e.metaKey;
    ...
    var r, i = 0, s = 0, o = ssc_overflowingAncestor(ssc_activeElement), u = o.clientHeight;
    switch (o == document.body && (u = window.innerHeight), e.keyCode) {
      case ssc_key.up:
        s = -ssc_arrowscroll;
        break;
...
function ssc_overflowingAncestor(e) {
    ...
    do {
        ...
        "scroll" === overflow || "auto" === overflow)) return ssc_setCache(t, e);
...
function ssc_directionCheck(e, t) {
    e = e > 0 ? 1 : -1, t = t > 0 ? 1 : -1, (ssc_direction.x !== e || ssc_direction.y !== t) && (ssc_direction.x = e, 
    ssc_direction.y = t, ssc_que = []);
}

function ssc_pulse_(e) {
    var t, n, r;
    return e *= ssc_pulseScale, 1 > e ? t = e - (1 - Math.exp(-e)) : (n = Math.exp(-1), 
    e -= 1, r = 1 - Math.exp(-e), t = n + r * (1 - n)), t * ssc_pulseNormalize;
}
...
function sendmail() {
    var e = $("#email").val(), t = $("#name").val(), su = $("#subject").val(), n = "name    : " + $("#name").val() + "<br/>";
    n += "Email   : " + $("#email").val() + "<br/>", n += "Subject   : " + su + "<br/>", 
    n += "Message : " + $("#message").val();
    var o, a = "iete:++" + su;
    o = window.XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject("Microsoft.XMLHTTP"), 
    o.onreadystatechange = function() {
        4 == o.readyState && 200 == o.status && alert(o.responseText) && clearfields();
    }, o.open("GET", "includes/mailer.php?key=nadbl673ij9&token=x428dez569jliwc658521074hdrgzcnmtufs100&subject=" + a + "&body_html=" + n + "&body_text=&from=" + e + "&fromname=" + t, !0), 
    o.send();
}

function clearfields() {
    return $("#email").val() = "", $("#name").val() = "", $("#subject").val() = "", 
    !0;
}
...
+function(a) {
    ...
    var CanvasRenderer = function(el, options) {
        ...
        ctx.translate(options.size / 2, options.size / 2), ctx.rotate((-0.5 + options.rotate / 180) * Math.PI);
        ...
        var options = {}, currentValue = 0, init = function() {
            ...
            for (var i in defaultOptions) defaultOptions.hasOwnProperty(i) && (options[i] = opts && "undefined" != typeof opts[i] ? opts[i] : defaultOptions[i], 
            ...
            }), this.renderer = new options.renderer(el, options), this.renderer.draw(currentValue), 
...
ischrome && (ssc_addEvent("mousedown", ssc_mousedown), ssc_addEvent("mousewheel", ssc_wheel), 
ssc_addEvent("load", ssc_init)), function($) {
    ...
    var e, a, p = {}, h = document, i = window, f = h.documentElement, j = d.expando;
    d.event.special.inview = {
        ...
        if (d.each(p, function(a, b) {
            ...
            if (!(b = e)) {
                ...
                g.height || !(b = h.compatMode) && d.support.boxModel || (b = "CSS1Compat" === b ? f : h.body, 
                g = {
            ...
            for (e = b, a = a || {
                ...
                l = a.top > c.top ? "bottom" : a.top + e.height < c.top + l ? "top" : "both", c = m + "-" + l, 
...
}(jQuery, Modernizr), jQuery(function($) {
    "use strict";
    !function() {
        $("#pre-status").fadeOut(), $("#tt-preloader").delay(2e3).fadeOut("slow");
    }(), function() {
        ...
        $(".tt-fullHeight").height($(window).height()), $(window).resize(function() {
        ...
        visible && ($(this).find(".timer").each(function() {
            var $this = $(this);
            $({
                Counter: 0
            }).animate({
        ...
        visible && ($.each($("div.progress-bar"), function() {
            $(this).css("width", $(this).attr("aria-valuenow") + "%");
        }), $(this).unbind("inview"));
    }), $(".more-skill").bind("inview", function(event, visible, visiblePartX, visiblePartY) {
        visible && ($(".chart").easyPieChart({
            easing: "easeOut",
            delay: 3e3,
            barColor: "#68c3a3",
        ...
        $grid.shuffle({
            ...
            e.preventDefault(), $("#filter a").removeClass("active"), $(this).addClass("active");
        ...
        var iframe = document.getElementById("nofocusvideo"), player = $f(iframe);
        ...
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || $.stellar({
        ...
        var myLatlng = new google.maps.LatLng(9.9701763, 76.2841578), styles = [ {
            ...
            disableDefaultUI: !0,
            styles: styles
        }, map = new google.maps.Map(document.getElementById("mapCanvas"), mapOptions), contentString = "IETE Kochi center", marker = new google.maps.Marker({
            position: myLatlng,
            map: map,
